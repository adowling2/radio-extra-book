...
\(-20n\ \si{\decibel}\)/decade & Roll-off of an \(n\)-pole response. & \cref{ch:filters} \\
\addlinespace
...
\(G=\wzero^2/(s^2+\tfrac{\wzero}{Q}s+\wzero^2)\) & LC low-pass as a filter. & \cref{sec:lc-lowpass} \\
\addlinespace
...
\(\wzero=1/\sqrt{R_1R_2C_1C_2}\) & Sallen--Key corner frequency. & \cref{ch:active} \\
