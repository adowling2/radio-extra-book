...
\(R_{\mathrm{AC}}\propto\sqrt f\) & Skin effect raises AC resistance with frequency. & \cref{sec:selfresonance} \\
...
\addlinespace
\(y=\sum_n G(\jj n\omega_0)c_n\ee^{\jj n\omega_0 t}\) & Fourier: \(G\) at the harmonics is the whole answer. & \cref{sec:fourier} \\
\addlinespace
