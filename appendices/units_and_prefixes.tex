...
\label{app:units}
A one-page quick reference for exam conditions. \Cref{ch:foundations} develops where
these relationships come from and why the ampere, not the coulomb, is the SI base
unit; this appendix is only the lookup table.
