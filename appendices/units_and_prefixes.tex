...
until its reference is known, and two of the units are easy to confuse.
...
dBm/Hz & \cref{sec:noisefloor} & Power \emph{spectral density}: power per unit bandwidth; a matched source at \SI{290}{\kelvin} supplies approximately \SI{-174}{dBm} per hertz. \\
