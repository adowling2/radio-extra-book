...
| `G9D13` | NCVEC 1st errata. **Last in its group**, so no interior gap — this one was missing from earlier versions of this table entirely. See the note below. |
| `G6B09` | NCVEC 2nd errata. G6B left with 11 questions, and this export has exactly 11. |
...
| `G1C09` | NCVEC 6th errata, 2026-02-04. G1C therefore has 8, which is what this export has — note NCVEC's own syllabus header still says 55 for all of G1, a count set by the 3rd errata and never updated; the true current figure is 52. |
