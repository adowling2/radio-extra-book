...
DDS replaced the variable-frequency oscillator. The cost is spurious outputs: the
accumulator's finite width means the phase advances in slightly wrong increments, and
that periodic phase error appears as discrete spurs rather than as broadband noise.
