...
\]
This is the Laplace rule \(\dd/\dd t\to s\) from \cref{ch:linsys} evaluated on the
imaginary axis \(s=\jj\omega\); it turns the differential equations of a circuit
into algebra for sinusoidal steady state.
