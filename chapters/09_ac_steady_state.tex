...
\emph{average} power over the whole transmission is much lower---speech spends most
of its time well below peak---which is why an amplifier can be rated for
\SI{100}{\watt} PEP on single sideband while its heat sink need not dissipate
\SI{100}{\watt} continuously.
\end{workedbox}
