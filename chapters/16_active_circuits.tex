...
groundwork from \cref{ch:linsys}---closed-loop gain \(A/(1+A\beta)\), the
large-loop-gain limit \(A_{\text{cl}}\to1/\beta\), and pole motion under
feedback---is the backbone of this chapter; here it is put to work.
