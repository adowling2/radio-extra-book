...
effect drives its AC resistance up as \(\sqrt f\). For the exam the two consequences
worth carrying are that a bypass capacitor or an RF choke simply stops working above
its own \(f_{\mathrm{SRF}}\), and that a coil's \(Q\) falls at the top of its range
because \(R\) is rising while \(\omega L\) is. \Cref{ch:measurement} runs the same
