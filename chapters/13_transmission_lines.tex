...
radiation---but electrically it behaves like one. The one-port impedance is the
series-RLC impedance of \cref{ch:ac},
\[
...
reactance vanishes and \(Z=R_{\text{rad}}\) is purely real.
