...
frequency responses, and feedback. The earlier Part~III chapters supplied circuit
components, conservation laws, and phasor impedance. This chapter states the
pattern that follows: every circuit is one of those systems, and each view exposes
a different feature of the same object.
...
What about a five-pole filter, three-stage amplifier, or feed line? The factoring
theorem of \cref{ch:highorder} writes each as a \emph{cascade} of the rows above.
Part~IV applies that result.
