...
Part~II built the generic linear-systems toolkit. Part~III now grounds it in real
circuits, and this chapter supplies the physical laws---conservation and the
element equations---that turn a schematic into the differential equations and
state-space models of \cref{ch:linsys}.
