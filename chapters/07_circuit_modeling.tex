...
A real circuit contains fields distributed through space. The \textbf{lumped-
...
holds when the circuit is small relative to the signal wavelength, so a change at
one end reaches the other essentially instantly. Long feed lines and antennas at
radio frequencies (RF) require the distributed model of \cref{ch:lines}.
