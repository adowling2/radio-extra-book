...
long convention: \(Q\) is both the quality factor and reactive power, and
\(\beta\) is both the feedback fraction and the transmission-line phase constant;
the surrounding formula makes clear which is meant.
