...
chemical engineer's controls perspective. I wrote it for myself. I am a chemical
...
poles, and read its Bode and root-locus plots. The book therefore treats a
...
In process-control courses, I emphasize differential-equation models and
state-space analysis; frequency-domain analysis yields to nonlinear dynamics,
optimization, and model predictive control. Radio provided a useful reason to
return to those classical tools. A sinusoidal input can feel contrived in many
chemical-engineering applications. In AC circuits, it is the natural view.

I developed this book with substantial assistance from large language models.
ChatGPT generated the initial outline; Claude Code helped refine, critique,
...
This book is deliberately narrow. It develops the circuit theory the exam draws
on and leaves the rest of the syllabus alone. The exam draws one question from
each of fifty topic groups, and passing requires thirty-seven correct. It
