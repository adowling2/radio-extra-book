...
The question pools are the only sources that determine exam wording and keyed
answers, and they are public domain: every pool identifier and answer letter
quoted in this book was checked against the NCVEC releases
...
General licensee needs before Extra; it is never otherwise mentioned.

The RF, microwave, measurement, receiver, and control texts cited throughout
were used to audit technical claims and calculations and to direct readers to
fuller treatments. Pinpoint page citations identify where a reader can continue;
the derivations, prose, examples, and figures here remain this book's own. Beyond
those technical sources, the \emph{ARRL Extra Class License Manual}
\cite{arrl_extra_12} and several earlier study guides
...
the author's own earlier draft. Full citations appear in the Bibliography.
