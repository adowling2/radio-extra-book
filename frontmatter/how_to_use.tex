...
practice in Part~V) is the fastest route---but see the scope note in the preface:
...
\item[Part V --- Practice and Study] an exam map, reasoning through real
question-pool items, and cross-chapter problems that each require several chapters at
once.
\end{description}
...
column saying where each result is derived), a units and prefix reference, and a
glossary.
