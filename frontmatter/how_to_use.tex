...
range, and measurement. Almost nothing here is derived from scratch---the point
is that the earlier models already contain the answers. Two chapters make that
unusually literal: \cref{ch:dsp} gets the whole of sampling out of the mixer's
multiplication, and \cref{ch:noise} gets every receiver specification out of one
noise formula and one power series.
