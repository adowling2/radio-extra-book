...
Energy & \(E,\mathcal{H}\) & \si{\joule} & Stored or dissipated energy. \\
...
\(\SI{20}{\decibel/decade}\) is about \(\SI{6}{\decibel/octave}\).
...
distance from the origin is \(\omega_0\). For a feedback loop,
\[
...
real \(R_{\text{hi}}>R_{\text{lo}}\) with an L-network,
\[
